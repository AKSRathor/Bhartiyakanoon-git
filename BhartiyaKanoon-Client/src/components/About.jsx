      ...
      <section className='about'>
        ...
        <div className='container flex mtop'>
          <div className='left row'>
            ...
            <p>Our LegalVault was established in 2023 with the goal of transforming the way individuals and businesses store, manage, and share their essential documents. We identified the potential of blockchain technology to address the limitations of traditional database storage methods, such as security, transparency, and control.
